package com.example.iloveyoujitu;
...
public class MainActivity extends AppCompatActivity {
    ...
    List<MediaStore.Video> all_videos;
    ...
    private void getJsonData() {
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(ConversationActions.Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i< videos.length();i++){
                        ...
                        MediaStore.Video v = new MediaStore.Video();
